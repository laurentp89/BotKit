/* Suponemos que existe un variable SECRET_NAME en el parameter store o en el archivo .env.
Este archivo carga todas las credenciales asociadas con este Secret Name */
  ...
  try {
    ...
    if (data.SecretString) {
      ...
      for (const envKey of Object.keys(secrets)) {
        ...
        logger.info(`✔ Se cargó ${envKey} a las variables de ambiente: ${secrets[envKey]}`);
      }
