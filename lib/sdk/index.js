...
function runComponentHandler(botId, componentId, eventName, reqPayload) {
  ...
  console.log(_event);
  console.log(_event.ackImmediately);
  console.log(_event.callback);
  console.log(botHandler);
  try {
    var eventHandler = _event.ackImmediately
            ? Promise.method(
                  _.partialRight(botHandler[_event.callback], _.noop),
              )
      : Promise.promisify(botHandler[_event.callback]);
  ...
  return Promise.try(function () {
    ...
    return eventHandlerP.then(function (response) {
      if (!_event.processResponse) {
        return request;
      }
            if (
                response &&
                !(response instanceof ObjectType) &&
                !(response instanceof AsyncResponse)
            ) {
...
module.exports = {
  ...
  sendUserMessage: function (request, callback) {
    ...
    return invokeSendUserMessage(request).nodeify(callback);
  },
  ...
  sendBotMessage: function (request, callback) {
    ...
    return invokeSendBotMessage(request).nodeify(callback);
  },
  ...
  sendAlertMessage: function (request, callback) {
    ...
    return invokeSendAlertMessage(request).nodeify(callback);
  },
  ...
  resetBot: function (request, callback) {
    ...
    return invokeResetBot(request).nodeify(callback);
  },
  ...
  startAgentSession: function (request, callback) {
    ...
    return invokeStartAgentSession(request).nodeify(callback);
  },
  ...
  clearAgentSession: function (request, callback) {
    ...
    return invokeClearAgentSession(request).nodeify(callback);
  },
  ...
  getMessages: function (request, callback) {
    ...
    return getMessages(request).nodeify(callback);
  },
  ...
  extendRequestId: function (request, callback) {
    ...
    return extendRequestId(request).nodeify(callback);
  },
  ...
  fetchBotVariable: function (request, langArr, callback) {
    ...
    return fetchBotVariable(request, langArr).nodeify(callback);
  },
  ...
  skipUserMessage: function (request, callback) {
    ...
    return invokeSkipUserMessage(request).nodeify(callback);
  },
  ...
  skipBotMessage: function (request, callback) {
    ...
    return invokeSkipBotMessage(request).nodeify(callback);
  },
  clearConversationSession: function (request, callback) {
    ...
    return clearConversationSession(request).nodeify(callback);
  },
  ...
  sendFeedbackMessage: function (request, payload, callback) {
    ...
    return invokeSendFeedbackMessage(request, payload).nodeify(callback);
  },
};
