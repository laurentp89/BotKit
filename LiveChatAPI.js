...
function initChat(visitorId, data) {
    ...
    return makeHttpCall("post", url, formData, headers)
        .then(function (res) {
            return res.data;
        })
        .catch(function (err) {
...
var getMsgUrl =
    "https://api.livechatinc.com/visitors/{visitorId}/chat/get_pending_messages?licence_id={licence_id}&secured_session_id={secured_session_id}&last_message_id={last_message_id}";
function getPendingMessages(visitorId, ssid, last_message_id, licence_id) {
    var url = template.parse(getMsgUrl).expand({
        visitorId: visitorId,
        secured_session_id: ssid,
    ...
    return makeHttpCall("get", url, null, headers)
        .then(function (res) {
            return res.data;
        })
        .catch(function (err) {
